...
# --- Завантаження даних (відповідає Main.R) ---
categorised_feedback <- readxl::read_excel("data/Feedback_Classified.xlsx", sheet = 1) |>
  janitor::clean_names() |>
  mutate(
    user_id = as.numeric(user_id),
    date = lubridate::parse_date_time(date, orders = c("mdy_HMS", "dmy_HMS", "dmy", "mdy"))
  )

user_status <- read_csv("data/user_status.csv", show_col_types = FALSE) |>
  select(c(1, 2, 3)) |>
  janitor::clean_names() |>
...
# --- Об'єднання та підрахунок (логіка з Main.R) ---
